...
} from "@/components/story-card/seller-stories"
...
/>`}
        ...
        <Subsection id="story-card-import" title="3. Import">
          <DocsImportBlock
            code={`import { StoryCard } from "@/components/story-card/seller-stories"`}
          />
          <p className="mt-3 text-base leading-relaxed">
            Styles live in{" "}
            <code>src/components/story-card/seller-stories.css</code>. Media depth uses{" "}
            <code>matchy-elevation-4</code>; the top title fade reuses shared{" "}
            <code>matchy-card-footer--top</code> from{" "}
            <code>src/components/product-card/card-footer.css</code>. Shop identity uses{" "}
            <code>SellerAvatar</code>.
          </p>
        </Subsection>
