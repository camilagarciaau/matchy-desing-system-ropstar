...
import "@/patterns/swipe-deck/swipe-deck.css"
import "@/components/product-card/product-card-face.css"
...
>
  ...
  {isActive ? <span>Home</span> : null}
        ...
        <Subsection id="button-import" title="3. Import">
          <DocsImportBlock code={`import { Button } from "@/components/button/button"`} />
          <p className="mt-3 text-base leading-relaxed">
