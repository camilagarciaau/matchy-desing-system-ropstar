/**
 * This is the Matchy Button — do NOT run `npx shadcn add button`.
 * That CLI targets components/ui/ and will create a conflicting
 * components/ui/button.tsx instead of updating this file.
 * Matchy button styles live in foundations/buttons/matchy-buttons.css.
 */
