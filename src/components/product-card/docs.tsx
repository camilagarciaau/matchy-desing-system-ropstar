...
import { marketplaceCatalog } from "@/patterns/home/marketplace-catalog"
import { LoadingScreen } from "@/components/loading/loading-spinner"
import { ProductCardFace } from "@/components/product-card/product-card-face"
import {
  fashionLoadingQuotes,
  swipeDeckInventory,
} from "@/patterns/swipe-deck/mock-data"
...
/>`}
        ...
        <Subsection id="product-card-face-import" title="3. Import">
          <DocsImportBlock
            code={`import { ProductCardFace } from "@/components/product-card/product-card-face"`}
          />
          <p className="mt-3 text-base leading-relaxed">
            Styles live in{" "}
            <code>src/components/product-card/product-card-face.css</code> (imported by
