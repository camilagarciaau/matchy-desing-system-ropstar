...
import { SellerAvatar } from "@/components/avatar/seller-avatar"
...
/>`}
        ...
        <Subsection id="seller-avatar-import" title="3. Import">
          <DocsImportBlock
            code={`import { SellerAvatar } from "@/components/avatar/seller-avatar"`}
          />
          <p className="mt-3 text-base leading-relaxed">
            Styles live in{" "}
            <code>src/components/avatar/seller-avatar.css</code> (imported by the
            component).
          </p>
        </Subsection>
